...
class SslCommerzPaymentController extends Controller
{
    ...
    public function success(Request $request)
    {
        ...
        if ($order_details->order_status == 'Pending') {
            ...
            return redirect('/checkout-complete')->with('message', 'Invalid Transaction');
    ...
    public function fail(Request $request)
    {
        ...
        if ($order_details->order_status == 'Pending') {
            ...
            return back()->with('message', 'Transaction is Falied');
        } else if ($order_details->order_status == 'Processing' || $order_details->status == 'Complete') {
    ...
    public function ipn(Request $request)
    {
        ...
        if ($request->input('tran_id')) #Check transation id is posted or not.
        {
            ...
            if ($order_details->order_status == 'Pending') {
                ...
                if ($validation == TRUE) {
                    ...
                    */
                    ...
                    echo "Transaction is successfully Completed";
            return back('/complete-order')->with('message', 'Transaction is successfully Completed');
            ...
            return back('/complete-order')->with('message', 'Transaction is already successfully Completed');
