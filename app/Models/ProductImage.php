...
class ProductImage extends Model
{
    ...
    private static function getImageUrl($image)
    {
        ...
        self::$directory    = "uploaded-files/product-other-images/";
        $image->move(self::$directory, self::$imageName);
        return  self::$directory.self::$imageName;
    }
    public static  function newProductImage($other_images,$id)
    {
    ...
    public static function updateProductImage($other_images,$id)
        {
            ...
            self::newProductImage($other_images,$id);
        }
