			...
			<div class="page">
				<div>
					...
					<div class="col col-login mx-auto text-center">
						<a href="index.html">
							<img src="{{ asset('/') }}website/assets/img/logo-light.png" class="header-brand-img" alt="">
						</a>
					</div>
						...
						<div class="wrap-login100 p-0">
							<div class="card-body">
								<form class="login100-form validate-form" action="{{ route('register') }}" method="post" >
                                    ...
                                    <div class="wrap-input100 validate-input" data-bs-validate = "Password is required">
										<input class="input100" type="password" name="password_confirmation" placeholder="Confim Password">
										<span class="focus-input100"></span>
										<span class="symbol-input100">
											<i class="zmdi zmdi-lock" aria-hidden="true"></i>
										</span>
									...
									<div class="container-login100-form-btn">
										<button type="submiy" class="login100-form-btn btn-primary">
											Register
										</button>
									</div>
