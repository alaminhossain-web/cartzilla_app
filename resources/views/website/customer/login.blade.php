          ...
          <div class="card-body">
            ...
            <form method="post" action="{{route('login-check')}}">
              ...
              <div class="input-group mb-3"><i class="ci-mail position-absolute top-50 translate-middle-y text-muted fs-base ms-3"></i>
                <input class="form-control rounded-start" type="text" name="user_name" placeholder="Your Email or Phone" required>
              </div>
        ...
        <form method="post" action="{{ route('new-customer')}}">
          ...
          <div class="row gx-4 gy-3">
            ...
            <div class="col-sm-6">
              ...
              <input class="form-control" type="number" name="mobile" required id="reg-phone">
