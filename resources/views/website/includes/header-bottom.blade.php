<div class="navbar-sticky bg-light">
    <div class="navbar navbar-expand-lg navbar-light">
        <div class="container"><a class="navbar-brand d-none d-sm-block flex-shrink-0" href="{{ route('home') }}"><img
                    src="{{ asset('/') }}website/assets/img/logo-dark.png" width="142" alt="Cartzilla"></a><a
                class="navbar-brand d-sm-none flex-shrink-0 me-2" href="{{ route('home') }}"><img
                    src="{{ asset('/') }}website/assets/img/logo-icon.png" width="74" alt="Cartzilla"></a>
            ...
            <div class="navbar-toolbar d-flex flex-shrink-0 align-items-center">
                ...
                </a><a class="navbar-tool d-none d-lg-flex me-2" href="account-wishlist.html"><span
                        class="navbar-tool-label">{{ count($wishlist) }}</span><span
                ...
                @if (Session::get('customer_id'))
                    <div class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#"
                            data-bs-toggle="dropdown" data-bs-auto-close="outside"><i
                                class="navbar-tool-icon ci-user"></i> {{ Session::get('customer_name') }}</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('customer.dashboard') }}"><i
                                        class="navbar-tool-icon ci-home"></i> Dashboard</a></li>
                            <li><a class="dropdown-item" href="{{ route('customer-logout') }}"><i
                                        class="navbar-tool-icon ci-turn-off"></i> Logout</a></li>
                        </ul>
                    </div>
                @else
                ...
                <div class="navbar-tool dropdown ms-3">
                    <a class="navbar-tool-icon-box bg-secondary dropdown-toggle" href="{{ route('cart.index') }}"><span
                            class="navbar-tool-label">{{ count(Cart::content()) }}</span><i
                    ...
                    <!-- Cart dropdown-->
                    @if (count(Cart::content()) == 0)
                    <div class="dropdown-menu dropdown-menu-end pt-2 text-center">
                      <div class="widget widget-cart px-3 pt-2 pb-3" style="width: 20rem;">
                        <img src="{{ asset('/') }}upload/empty.png" width='40' class="d-inline-block mb-2" alt="Empty cart">
                        ...
                        <div class="widget widget-cart px-3 pt-2 pb-3" style="width: 20rem;">
                            ...
                            <div data-simplebar data-simplebar-auto-hide="false">
                                ...
                                @foreach (Cart::content() as $cartItem)
                                    <div class="widget-cart-item pb-2 border-bottom">
                                        <a class="btn-close text-danger" href="{{ route('cart.delete', session('rowId')) }}" aria-label="Remove"><span
                                        ...
                                        <div class="d-flex align-items-center"><a class="flex-shrink-0"
                                                href="shop-single-v1.html"><img
                                                    ...
                                                    style="height: 64px; width:64px" alt="Product"></a>
                                            <div class="ps-2">
                                                <h6 class="widget-product-title"><a
                                                        href="shop-single-v1.html">{{ $cartItem->name }}</a></h6>
                                                <div class="widget-product-meta"><span
                                                        class="text-accent me-2">${{ $cartItem->price }}.<small>00</small></span><span
                                                        class="text-muted">x {{ $cartItem->qty }}</span></div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="d-flex flex-wrap justify-content-between align-items-center py-3">
                                <div class="fs-sm me-2 py-2"><span class="text-muted">Subtotal:</span><span
                                        class="text-accent fs-base ms-1">${{ $sum }}.<small>00</small></span>
                                </div><a class="btn btn-outline-secondary btn-sm"
                                    href="{{ route('cart.index') }}">Expand cart<i
    ...
    <div class="navbar navbar-expand-lg navbar-light navbar-stuck-menu mt-n2 pt-0 pb-2">
        <div class="container">
            <div class="collapse navbar-collapse" id="navbarCollapse">
                        ...
                        <ul class="dropdown-menu">
                            @foreach ($categories as $category)
                                <li class="dropdown mega-dropdown">
                                    <a class="dropdown-item {{ count($category->subCategory) > 0 ? ' dropdown-toggle' : '' }}"
                                        href="{{ route('product-category', $category->id) }}"><i
                                            class="ci-list opacity-60 fs-lg mt-n1 me-2"></i>{{ $category->name }}</a>
                                            ...
                                            <div class="d-flex flex-wrap flex-sm-nowrap px-2">
                                                ...
                                                <div class="mega-dropdown-column d-none d-lg-block py-4 text-center"><a
                                                        class="d-block mb-2" href="#"><img
                                                            src="{{ asset('/') }}website/assets/img/shop/departments/07.jpg"
                ...
                <!-- Primary menu-->
                <ul class="navbar-nav">
                    <li class="nav-item dropdown @yield('home')"><a class="nav-link dropdown-toggle"
                ...
                <li class="dropdown position-static mb-0"><a class="dropdown-item py-2" href="home-single-store.html"><span class="d-block text-heading">Single Product Store</span><small class="d-block text-muted">Single product / mono brand</small></a>
                  <div class="dropdown-menu h-100 animation-none mt-0 p-3"><a class="d-block" href="home-single-store.html" style="width: 250px;"><img src="{{ asset('/') }}website/assets/img/home/preview/th05.jpg" alt="Single Product / Brand Store"></a></div>
                    ...
                    <li class="nav-item dropdown @yield('shop')"><a class="nav-link dropdown-toggle"
                            href="#">Shop</a>
                        <!-- <div class="dropdown-menu p-0">
                <div class="d-flex flex-wrap flex-sm-nowrap px-2">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="sticky-footer.html">Sticky Footer Demo</a></li>
                    ...
                    <li class="nav-item dropdown @yield('about')"><a class="nav-link dropdown-toggle"
                            href="{{ route('about') }}">About Us</a>
                    <li class="nav-item dropdown @yield('contact')"><a class="nav-link dropdown-toggle"
