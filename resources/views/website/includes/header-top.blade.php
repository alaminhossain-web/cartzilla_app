<div class="topbar topbar-dark bg-dark">
    <div class="container">
      ...
      <div class="ms-3 text-nowrap"><a class="topbar-link me-4 d-none d-md-inline-block" href="order-tracking.html"><i class="ci-location"></i>Order tracking</a>
        <div class="topbar-text dropdown disable-autohide"><a class="topbar-link dropdown-toggle" href="#" data-bs-toggle="dropdown"><img class="me-2" src="{{ asset('/') }}website/assets/img/flags/en.png" width="20" alt="English">Eng / $</a>
