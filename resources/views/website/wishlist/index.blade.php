    ...
    <div class="row">
        ...
        <div class="bg-white rounded-3 shadow-lg pt-1 mb-5 mb-lg-0">
          <div class="d-md-flex justify-content-between align-items-center text-center text-md-start p-4">
            <div class="d-md-flex align-items-center">
              <div class="img-thumbnail rounded-circle position-relative flex-shrink-0 mx-auto mb-2 mx-md-0 mb-md-0" style="width: 6.375rem;"><span class="badge bg-warning position-absolute end-0 mt-n2" data-bs-toggle="tooltip" title="Reward points">384</span><img class="rounded-circle" src="{{asset('/')}}upload/user.jpg" alt="Susan Gardner"></div>
              <div class="ps-md-3">
                <h3 class="fs-base mb-0"> {{Session::get('customer_name')}}</h3><span class="text-accent fs-sm"></span>
              </div>
          ...
          <div class="d-lg-block collapse" id="account-menu">
            ...
            <ul class="list-unstyled mb-0">
              ...
              <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 active" href="account-wishlist.html"><i class="ci-heart opacity-60 me-2"></i>Wishlist<span class="fs-sm text-muted ms-auto">{{count($products)}}</span></a></li>
      ...
      <section class="col-lg-8">
        ...
        <div class="d-sm-flex justify-content-between mt-lg-4 mb-4 pb-3 pb-sm-2 border-bottom">
          <div class="d-block d-sm-flex align-items-start text-center text-sm-start"><a class="d-block flex-shrink-0 mx-auto me-sm-4" href="shop-single-v1.html" style="width: 10rem;"><img src="{{asset($item->product->image)}}" alt="Product"></a>
            <div class="pt-2">
              <h3 class="product-title fs-base mb-2"><a href="shop-single-v1.html">{{$item->product->name}}</a></h3>
              <div class="fs-sm"><span class="text-muted me-2">Brand:</span>{{$item->product->brand->name}}</div>
              @foreach ($item->product->colors as $color)
              <div class="fs-sm"><span class="text-muted me-2">Color:</span>{{$color->color->name }},</div>
              @endforeach
              <div class="fs-lg text-accent pt-2">$.{{$item->product->selling_price}}<small>50</small></div>
            </div>
          </div>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        <h3>No Product in your wishlist..</h3>
                    </div>
                </div>
            </div>
        </div>
