                    ...
                    @foreach ($products as $key => $product)
                        ...
                        <div class="d-sm-flex justify-content-between align-items-center my-2 pb-3 border-bottom">
                            ...
                            <div class="d-block d-sm-flex align-items-center text-center text-sm-start"><a
                                ...
                                <div class="pt-2">
                                    <h3 class="product-title fs-base mb-2"><a
                                            href="shop-single-v1.html">{{ $product->name }}</a></h3>
                                    <div class="fs-sm"><span
                                            class="text-muted me-2">Size:</span>{{ $product->options->size }}</div>
                                    <div class="fs-sm"><span
                                            class="text-muted me-2">Color:</span>{{ $product->options->color }}</div>
                            ...
                            <div class="pt-2 pt-sm-0 ps-sm-3 mx-auto mx-sm-0 text-center text-sm-start"
                                ...
                                <input class="form-control" type="number" name="data[{{ $key }}][qty]"
