        ...
        <div class="row">
          ...
          <section class="col-lg-8">
            ...
            <div class="row mx-n2">
              ...
              <div class="col-md-4 col-sm-6 px-2 mb-4">
                <div class="card product-card">
                  <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to wishlist"><i class="ci-heart"></i></button><a class="card-img-top d-block overflow-hidden" href="{{ route('product-detail',$product->id) }}">
                    <img src="{{ asset($product->image) }}" alt="Product" style="height: 250px; width:100%" class="mx-auto"></a>
                  <div class="card-body py-2"><a class="product-meta d-block fs-xs pb-1" href="">{{$category->name}}</a>
                    <h3 class="product-title fs-sm"><a href="{{route('product-detail',$product->id)}}">{{$product->name}}</a></h3>
            ...
            {{-- <div class="row mx-n2">
              ...
              <div class="col-md-4 col-sm-6 px-2 mb-4">
                <div class="card product-card"><span class="badge bg-danger badge-shadow">Sale</span>
                  <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to wishlist"><i class="ci-heart"></i></button><a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img src="{{ asset('/') }}website/assets/img/shop/catalog/13.jpg" alt="Product"></a>
              ...
              <div class="col-md-4 col-sm-6 px-2 mb-4">
                <div class="card product-card">
                  <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to wishlist"><i class="ci-heart"></i></button><a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img src="{{ asset('/') }}website/assets/img/shop/catalog/14.jpg" alt="Product"></a>
              ...
              <div class="col-md-4 col-sm-6 px-2 mb-4">
                <div class="card product-card">
                  <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to wishlist"><i class="ci-heart"></i></button><a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img src="{{ asset('/') }}website/assets/img/shop/catalog/15.jpg" alt="Product"></a>
